...
def AddSoftware(UserName, SoftwareName, Version, CVE=None, Summary=None, Recommendation=None, LastScan=None):
    global conn, cur
    ...
    user_id = row[0]
    cur.execute("""
        INSERT INTO "Software" (Name,Version, CVE, Summary, Recommendation, LastScan, UserID)
        VALUES (%s,%s, %s, %s, %s, %s, %s) ON CONFLICT (Name, UserID) DO NOTHING
    RETURNING ID;
    """, (SoftwareName,Version, CVE, Summary, Recommendation, LastScan, user_id))
...
def UpdateSoftwareByID(SoftwareID, Name=None, Version=None, CVE=None, Summary=None, Recommendation=None, LastScan=None):
    global conn, cur
    fields = []
    values = []
